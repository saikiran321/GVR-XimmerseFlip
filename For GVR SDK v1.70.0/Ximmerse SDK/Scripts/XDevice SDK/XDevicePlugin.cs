...
namespace Ximmerse.InputSystem {
    ...
    public partial class XDevicePlugin {
        ...
        public static int DeviceVersion = XIM_DK4_DIS01;//XIM_DK4_DIS01,XIM_RD06, XIM_CV1
        ...
        internal static class NativeMethods {
            ...
            ret=s_XDeviceApi.CallStatic<int>("init",currentActivity,DeviceVersion,4);
            ...
            if (s_XDeviceApi != null)
            {
            s_XDeviceApi.CallStatic("setControllerCount", num);
            Debug.Log("!!!Set Max Connection");
            }
            }
            ...
            if(s_XDeviceApi!=null) 
            {
            return s_XDeviceApi.CallStatic<int>("getControllerCount");
            }
            return 2;
            }
            #endif
        ...
        public static int Init(){
            ...
            #endif
            NativeMethods.XDeviceSetInt(ID_CONTEXT, kField_VIDInt, 0x1F3B);
            NativeMethods.XDeviceSetInt(ID_CONTEXT, kField_PIDInt, 0);
	...
	public partial class XDevicePlugin {
		...
		internal static class NativeMethods {
			...
			public static int XDeviceInit(){
				...
				int ret=-1;
				if(PlayerPrefsEx.GetBool("xdevice.noServicesInAndroid",false)){
					using(AndroidJavaClass jc=new AndroidJavaClass("com.unity3d.player.UnityPlayer")){
					using(AndroidJavaObject currentActivity=jc.GetStatic<AndroidJavaObject>("currentActivity")){
						ret=s_XDeviceApi.CallStatic<int>("init",currentActivity,0x4001,1);
						SetBool(ID_CONTEXT,kField_CtxCanProcessInputEventBool,false);
					}}
				}else{
					ret=s_XDeviceApi.CallStatic<int>("initInUnity");
...
#endif
			NativeMethods.XDeviceSetInt(XDevicePlugin.ID_CONTEXT,kField_CtxDeviceVersionInt,PlayerPrefsEx.GetInt("XimmerseDevice.type",0x4000));
        ...
        public static string getDeviceAddress(int which){
            string macAddress = "";
#if UNITY_ANDROID && !UNITY_EDITOR
            AndroidJavaClass s_XDeviceApi=new AndroidJavaClass("com.ximmerse.sdk.XDeviceApi");
			macAddress = s_XDeviceApi.CallStatic<string>("getDeviceAddress",which);
#endif
            return macAddress;
		}

        public static void OnPauseUnity(bool isPause){
#if UNITY_ANDROID && !UNITY_EDITOR
            AndroidJavaClass s_XDeviceApi=new AndroidJavaClass("com.ximmerse.sdk.XDeviceApi");
            s_XDeviceApi.CallStatic("OnPauseUnity",isPause);
#endif
		}
